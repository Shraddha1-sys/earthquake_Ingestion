...
if __name__ == '__main__':
    ...
    spark=SparkSession.builder.master('local[*]').appName('daily_data').getOrCreate()
# Get the data from the API
    ...
    upload_file = utils_obj.upload_to_gcs(response, 'earthquake_analysiss', 'pyspark/landing/20241022/Daily.json')

    # ================================================================================

    # read data from the GCS Bucket
    read_data = utils_obj.read_file_from_gcs('earthquake_analysiss', 'pyspark/landing/20241022/Daily.json')
    # print(read_data)
    ...
    write_data=utils_obj.upload_to_gcs(json_data,'earthquake_analysiss','silver/20241022/Daily.json')
